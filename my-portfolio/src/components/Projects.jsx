        ...
        <div className="pt-10 bg-gradient-to-b from-black via-gray-950 to-white " id="projects">
            <div className="mx-auto max-w-screen px-10 xs:px-6 lg:px-8">
                <div className="mx-auto max-w-2xl py-16 xs:py-24 lg:max-w-none lg:py-32">
                    ...
                    <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 grid-rows-2 lg:gap-7 lg:space-y-0">
                        {projects.map((projects) => (
                            <div key={projects.name} className="group relative">
                                <div className="h-full bg-gray-50 rounded-lg row-start-1">
                                    <div className="relative h-80 w-full overflow-hidden rounded-lg m:aspect-h-1 xs:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 xs:h-64">
