...
const About = () => {
    return (
        <div className="grid grid-cols-2 sx:grid-cols-1 lg:grid-cols-2 gap-4 items-center bg-white min-h-screen sx:min-h-[60vh] sm:min-h-[70vh] md:min-h-[70vh] lg:min-h-screen xxl:min-h-screen p-10" id='about'>
            <div className="ms-3 sx:ms-0">
                <h1 className="uppercase mb-4 text-black  xl:text-[100px] lg:text-7xl md:text-[90px] sm:text-5xl sx:text-4xl">Learn <br /> About Me</h1>
                <p className="text-justify text-gray-700 xl:text-xl lg:text-md md:text-[18px] sm:text-[11.5px] sx:text-[9px]">
